...
Console.WriteLine($"stato dell'index dopo la creazione dell'ultima istanza: \n {Product.CodeIndex}");

Console.WriteLine($"CodiceProdotto Formattato: \n {prod3.fmtCode()}");

Console.WriteLine(prod3.getFullName());
